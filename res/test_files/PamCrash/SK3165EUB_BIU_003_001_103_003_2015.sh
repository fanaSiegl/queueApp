...
if [ -r META_queue_session.ses -a -f /usr1/applications/ansa/BETA_CAE_Systems/meta_post_v19.1.1/meta_post64.sh ]; then   #konverze do metadb
    ...
    /usr1/applications/ansa/BETA_CAE_Systems/meta_post_v19.1.1/meta_post64.sh -b -foregr -virtualx_64bit -s META_queue_session SK3165EUB_BIU_003_001_103_003_2015 &>> SK3165EUB_BIU_003_001_103_003_2015.log
    sleep 5
